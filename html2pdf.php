...
<?php
$sessiondid=trim($_GET['sessionid']);
$toprint=trim($_GET['toprint']);
$tid=trim($_GET['tid']);
$url="http://localhost/ischool/printaction.php?sessionid=$sessiondid&toprint=$toprint&tid=$tid";

$html2dco=new HTML_TO_DOC ;
$html2dco->createDocFromURL($url,"printword.doc",False) ;
?>
<html>
<body>

<a href="printword.doc" target='_blank' title="Click here to open a Word document">Click here to open a Word document</a>
